    ...
    queryly = {
        ...
        init: function (querylykey, maincontent, config) {
            ...
            try {
                ...
                if ((typeof queryly.config != 'undefined' && queryly.config.pageservice) || queryly.querylydemo == 'related' || queryly.querylydemo == 'native' || queryly.querylydemo == 'hyperlink' || queryly.querylydemo == 'chat' || querylykey == '58971d435c9a4cef' || querylykey == '8bceb0a641b542b1') {
                    try {
        ...
        renderAdvancedResults: function (results) {
            ...
            try {
                ...
                if (typeof results.items == 'undefined' || results.items.length == 0) {
                    ...
                    queryly.searchcontainer.innerHTML = '<div style="margin: 50px;text-align: center;font-size: 30px;color: #444;line-height:35px;">' + queryly.noresultmessage + '</div>';
                    queryly.searchoutercontainer.style['display'] = 'block';
